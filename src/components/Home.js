  ...
  <>  
    ...
    <div className="left">
      ...
      <h2 className='iam'> <span className='span'> i'm </span> <span className='faizanansari' style={{ color: 'blue', fontWeight: 'bold' }}>
          ...
          <Typewriter
            words={['Ashnab Khan', 'ReactDeveloper','HTML','CSS','JAVASCRIPT']}
            loop={true}
            cursor
            cursorStyle='I'
            typeSpeed={70}
    ...
    <a href={myresume} download="myresume"> <button className=' me2'>Resume</button></a>
      <br />
    ...
    <div className="right">
      <img className='rightimage' src={myphoto} alt="" />
     ...
     <Link to={"https://www.linkedin.com/in/ashnab-khan-44346a277/"}> <FontAwesomeIcon className='iconss'   icon={faLinkedin} /> </Link>
      <Link to={"https://github.com/Ashh-khan"}> <FontAwesomeIcon  className='iconss'    icon={faGithub} /></Link>
      </div>
 ...
 <div class="container  project1">
  <div class="card" >
    ...
    <div className="card-body">
      ...
      <a href="https://ashh-khan.github.io/AC-and-Fridge-Showroom/" class="btn btn-primary">Go to github</a>
    </div>
  </div>
  ...
  <div class="card my-3">
    ...
    <div class="card-body">
      ...
      <a href="https://ashh-khan.github.io/the-car-showroom/" class="btn btn-primary">Go to github</a>
    </div>
  </div>
