...
function Contact() {
  ...
  return (
    ...
    <div class="col-4 lastwala">
      ...
      <p className='parancontact'> <FontAwesomeIcon className='iconcontact' icon={faPhone}/> Call to ask any quetions:- +919324453478</p>
      <p></p>
    </div>
    <div class="col-4 lastwala">
       
       <p className='parancontact'> <FontAwesomeIcon className='iconcontact' icon={faMessage}/> Email:- ashnabkhan2001@gmail.com</p>
       <p></p>
    </div>
    <div class="col-4 lastwala">
